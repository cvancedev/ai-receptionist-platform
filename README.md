...
Sprint 3 through Sprint 6 remain certified complete. Sprint 7.6 is complete with real-PostgreSQL evidence that invalid, stale, duplicate, malformed, unavailable, cross-scope, failed-transaction, and restart scenarios fail safely without fallback, repair, repinning, replay, or partial authority. The ordinary prototype remains fixture-backed, and no public administration, production authentication, real provider, customer release, external action, or end-to-end MVP work was added. Milestone 7.7 remains Not Started. See the [Sprint 7 Plan](docs/SPRINT_7_PLAN.md).
