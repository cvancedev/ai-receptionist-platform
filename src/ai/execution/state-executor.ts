...
export class DeterministicStateExecutor {
  ...
  private result(input: {
    ...
    const metadata: StateExecutionMetadata = {
      ...
      conversationId: input.request?.identity.conversationId ?? null,
      businessProfileId: input.request?.identity.businessId ?? null,
      businessProfileVersion: input.request?.identity.profileVersion ?? null,
